...
#+BEGIN_EXAMPLE
  n$ wcsing.sh wct0.8.0-ub1804.simg bash.rc /cvmfs
...
long time as files are downloaded.  Subsequent commands should be
faster.  
...
Todo is to update [[./wclsdev.rc]] to work in this mode.
